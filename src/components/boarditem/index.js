...
const BoardItem = ({item, onDelete, onEdit, navigation}) => {    

    const [select, setSelected] = useState(false);

    return (
        <TouchableOpacity style={styles.container} onPress={() => navigation.navigate('Lists')} onLongPress={() => {setSelected(!select)}}>
            <Image
